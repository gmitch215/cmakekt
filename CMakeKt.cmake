...
if (NOT DEFINED KN_DEFINITION_FILE_OUTPUT)
    set(KN_DEFINITION_FILE_OUTPUT "${CMAKE_CURRENT_BINARY_DIR}/build/cinterop/${PROJECT_NAME}-${PROJECT_VERSION}.def")
endif()

## KN_CINTEROP_FILE_OUTPUT
if (NOT DEFINED KN_CINTEROP_FILE_OUTPUT)
    set(KN_CINTEROP_FILE_OUTPUT "${CMAKE_CURRENT_BINARY_DIR}/build/cinterop/${PROJECT_NAME}-${PROJECT_VERSION}.klib")
endif()
